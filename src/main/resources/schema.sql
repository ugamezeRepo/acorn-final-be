...
(
    ...
    CONSTRAINT MESSAGE_CHANNEL_AUTHOR_ID_FK FOREIGN KEY (AUTHOR_ID) REFERENCES MEMBER (ID)
        ON DELETE CASCADE,
    CONSTRAINT MESSAGE_CHANNEL_CHANNEL_ID_FK FOREIGN KEY (CHANNEL_ID) REFERENCES CHANNEL (ID)
        ON DELETE CASCADE,
    CONSTRAINT MESSAGE_CHANNEL_TOPIC_ID_FK FOREIGN KEY (TOPIC_ID) REFERENCES TOPIC (ID)
        ON DELETE CASCADE
);
...
(
    ...
    CREATED_AT  DATE           NOT NULL,
    UPDATED_AT  DATE           NOT NULL,
    CONSTRAINT  MESSAGE_DM_AUTHOR_ID_FK FOREIGN KEY (AUTHOR_ID) REFERENCES MEMBER (ID)
        ON DELETE CASCADE,
    CONSTRAINT  MESSAGE_DM_DM_ID_FK FOREIGN KEY (DM_ID) REFERENCES DIRECT_MESSAGE (ID)
        ON DELETE CASCADE
);
