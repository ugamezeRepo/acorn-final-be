...
CREATE TABLE MESSAGE (
    ...
    CONSTRAINT MESSAGE_AUTHOR_ID_FK FOREIGN KEY (AUTHOR_ID) REFERENCES MEMBER (ID) ON DELETE CASCADE,
    CONSTRAINT MESSAGE_CHANNEL_ID_FK FOREIGN KEY (CHANNEL_ID) REFERENCES CHANNEL (ID) ON DELETE CASCADE,
    CONSTRAINT MESSAGE_TOPIC_ID_FK FOREIGN KEY (TOPIC_ID) REFERENCES TOPIC (ID) ON DELETE CASCADE
);
...
CREATE TABLE DIRECT_MESSAGE (
    ...
    CONSTRAINT TOPIC_MEMBER_ID_FK FOREIGN KEY (MEMBER_ID) REFERENCES MEMBER (ID) ON DELETE CASCADE,
    CONSTRAINT TOPIC_ANOTHER_ID_FK FOREIGN KEY (ANOTHER_ID) REFERENCES MEMBER (ID) ON DELETE CASCADE
);
